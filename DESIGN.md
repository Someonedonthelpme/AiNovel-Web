...
| 6b | Enemies after victory | **in progress** (user's call, 2026-09-11) | stage 0 fixed; stages 1–2 shipped (`settleFight`, `killed` deed, ambush); design in [Enemies after victory](#enemies-after-victory--decided-not-built) |
